    ...
    [(); N::COUNT_SERVICES]:,
{
    fn default() -> Self {
        Self {
            ...
            checkers_index: 0,
            arr: [0; N::ID_COUNT],
            checkers: valex_utils::ArrayInitializer::init(const |_| CheckerID::new()),
        }
    }
}
...
impl CountID {
    pub const fn calc<S0, N, E>(self) -> Self
    where
        S0: __pub::IsSubscribed<N, E>,
    {
        let (_0, _1) = crate::is_pub_impl_and_count::<S0, N, E>((self.0, self.1));
        Self(_0, _1)
    }
}
